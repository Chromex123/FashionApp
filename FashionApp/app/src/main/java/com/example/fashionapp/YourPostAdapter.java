...
public class YourPostAdapter extends RecyclerView.Adapter<YourPostAdapter.PostViewHolder> {
    ...
    Context context;
    private YourPostAdapter.OnImageSelectedListener listener;
    private YourPostAdapter.OnDeleteButtonListener deleteButtonListener;
    ...
    public YourPostAdapter(List<Post> postList, OnImageSelectedListener listener, OnDeleteButtonListener deleteButtonListener, Context context) {
    ...
    public PostViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.your_post_cell, parent, false);
    ...
    public void onBindViewHolder(@NonNull PostViewHolder holder, int position) {
        ...
        //Handling the delete post button
        holder.deleteButton.setColorFilter(Color.RED);
        holder.deleteButton.setOnClickListener(v -> {
            deleteButtonListener.onDeleteButtonClick(holder.getBindingAdapterPosition());
        });
    ...
    public static class PostViewHolder extends RecyclerView.ViewHolder {
        ...
        ImageButton upvoteButton, downvoteButton, saveButton, deleteButton;
